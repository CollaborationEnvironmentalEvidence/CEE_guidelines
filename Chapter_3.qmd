...
# Planning the conduct of an Evidence Synthesis {#sec-chapt3}

## **Options for engaging with CEE** {#sec-engage}
...
CEE evidence syntheses require the registration of their protocol (project plan) as an independent document, before the synthesis is conducted (See @sec-engage). There are several reasons for doing so:
