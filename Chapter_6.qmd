...
tab82 %>%
  ...
  footnote(
    general = paste(
      "Data are based on the selected dataset, with stocking-only interventions excluded.",
      "Lake areas, mean depths, retention times, pre-manipulation TP concentrations",
      "and fish removals were log-transformed before calculation of means and",
      "confidence intervals, and then back-transformed."
    ),
    general_title = ""
  )
```
