---
title: "Identifying the need for evidence, determining the evidence synthesis type, and establishing a Review Team"
format:
  html:
    toc: true
    toc-depth: 3
...
Questions arise in many forms and examples of common generic question types are listed in @tbl-commontype. Examples of scenarios that might generate a need for evidence are shown in Box 2.1.
...
The User and the Stakeholder Groups will have a very important role in the formulation of the review question, and in its phrasing but should not be directly involved in conducting the Evidence Synthesis. They may also help to establish the list of sources of evidence and search terms (by providing some of them, or checking the list for completeness). Involving many people at an early stage may be particularly critical if the findings are likely to be contested (Fazey et al. 2004). However, particularly for a Systematic Review, stakeholder input needs to be carefully managed to avoid the question becoming too broad, complex or just impossible to answer (Stewart & Liabo 2012). There are further opportunities throughout the review process for input from stakeholders, but as we shall see below, identifying and obtaining initial consensus on the question is crucial to the value of an evidence synthesis.
...
![](images/Fig-2.2-new.png)

**Figure 2.1. Model of potential benefits of stakeholder engagement (Haddaway *et al*. 2017). Models shows direction of benefit with respect to stakeholders (green arrows benefit the review, orange arrows benefit the stakeholders) .**
...
## **From a problem to a reviewable question:** **Question generation and formulation**
...
### **Open-framed and closed-framed questions**
...
**Figure 2.2. Relationship between a high-level open-framed policy question, potential generic solutions and individual interventions. After Pullin et al. (2009).**

### **Key elements of questions amenable to evidence** s**ynthesis**
...
**Table 2.3. Elements of a reviewable PICO/PECO question: normally a permutation of ‘does intervention/exposure I/E applied to populations of subjects P produce a different amount of a measurable outcome O when compared with comparator C?’**
...
-   A similar Systematic Review or Systematic Map has recently been completed (but see updating Section 1 and section 4.5)
